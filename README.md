...
| **Overall** | **passing** | 44/44 |

Last successful CI run on `main`: 2026-07-01 23:00 UTC ([`c4a1a68`](https://github.com/jholovacs/HomeAssistantAgent/actions/runs/28553296490))
<!-- CI-STATUS:END -->
