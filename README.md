...
| **Overall** | **passing** | 43/43 |

Last successful CI run on `main`: 2026-07-01 23:03 UTC ([`1e6fb5f`](https://github.com/jholovacs/HomeAssistantAgent/actions/runs/28553422501))
<!-- CI-STATUS:END -->
